...
dataframe_train, dataframe_validation = sklearn.model_selection.train_test_split(dataset, test_size=0.1, random_state=3)
...
print("Zaczynam wybór featureów")
selector = SequentialFeatureSelector(sklearn.linear_model.LinearRegression(), n_features_to_select='auto', direction='forward', n_jobs=-1)
selector.fit(final_train_vector,y_train)


final_train_vector = selector.transform(final_train_vector)
